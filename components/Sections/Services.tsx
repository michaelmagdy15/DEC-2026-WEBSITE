                                    ...
                                    >
                                        ...
                                        <div className="text-left flex-1">
                                            ...
                                            {activeServiceId === service.id && (
                                                <span className="text-[10px] text-primary uppercase tracking-widest font-bold">View Capabilities</span>
                                            )}
                                        </div>
                            ...
                            <AnimatePresence mode='wait'>
                                ...
                                >
                                    ...
                                    <div className="relative z-10">
                                        ...
                                        <p className="text-gray-400 text-base sm:text-lg leading-relaxed mb-8 sm:mb-12 border-l-2 border-primary pl-4 sm:pl-6">
                                                    ...
                                                    <ul className="space-y-4">
                                                        {detail.items.map((item, itemIdx) => (
                                                            <li key={itemIdx} className="flex items-start gap-3 group">
                                                                <CheckCircle2 className="w-5 h-5 text-[#333] group-hover:text-primary transition-colors mt-0.5 flex-shrink-0" />
