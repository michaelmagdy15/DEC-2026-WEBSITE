      ...
      <div className="absolute inset-0 z-10 flex flex-col justify-center px-6 md:px-20 pointer-events-none">
        <div className="max-w-4xl">
          <motion.h2 
            ...
            className="text-[#F58220] font-mono text-sm tracking-[0.3em] uppercase mb-4"
          >
          ...
          <motion.h1 
            ...
            className="text-5xl md:text-8xl text-white font-extrabold tracking-tighter leading-tight mix-blend-difference"
          >
            Visionary <br />
          ...
          <motion.p 
            ...
            className="mt-8 text-gray-300 max-w-lg text-lg leading-relaxed mix-blend-difference"
          >
