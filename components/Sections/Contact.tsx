        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10 sm:gap-16 mb-12 sm:mb-20">
          <div>
            ...
            <div className="flex flex-col sm:flex-row gap-3 sm:gap-4">
              <button className="px-6 sm:px-8 py-3 sm:py-4 bg-white text-black font-bold uppercase tracking-widest text-sm sm:text-base hover:bg-[#F58220] hover:text-white transition-colors duration-300 w-full sm:w-auto text-center">
                Start Project
              </button>
              <button className="px-6 sm:px-8 py-3 sm:py-4 border border-white/30 text-white font-bold uppercase tracking-widest text-sm sm:text-base hover:border-[#F58220] hover:text-[#F58220] transition-colors duration-300 w-full sm:w-auto text-center">
                Careers
              </button>
            </div>
          </div>
