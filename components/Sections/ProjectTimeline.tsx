...
const ProjectCard: React.FC<{ project: Project; onClick: (p: Project) => void }> = ({ project, onClick }) => {
  return (
    <motion.div 
        ...
        className="relative group w-[85vw] md:w-[45vw] h-[50vh] md:h-[60vh] flex-shrink-0 mx-4 md:mx-10 overflow-hidden cursor-pointer bg-gray-900 border border-white/5"
    >
      ...
      >
        ...
        <h3 className="text-3xl md:text-5xl font-bold tracking-tight text-white mb-2">{project.title}</h3>
  ...
  return (
    <>
        ...
        <div className="sticky top-0 h-screen flex flex-col justify-center overflow-hidden">
            ...
            <h2 className="text-[#F58220] uppercase tracking-widest text-sm font-bold mb-2">Selected Works</h2>
            <h3 className="text-4xl md:text-5xl font-bold tracking-tight text-white">The Archive</h3>
            </div>

            {/* Horizontal Container */}
            <motion.div style={{ x }} className="flex items-center pl-6 md:pl-20">
                {/* Intro Card */}
                <div className="w-[30vw] md:w-[20vw] flex-shrink-0 mr-10">
                ...
                {/* Outro Card */}
                <div className="w-[40vw] flex-shrink-0 flex items-center justify-center ml-10">
                    <div className="text-center">
                        <h4 className="text-3xl text-white font-bold mb-4">Explore More</h4>
            ...
            {/* Progress Bar */}
            <div className="absolute bottom-10 left-6 right-6 md:left-20 md:right-20 h-1 bg-white/10 rounded-full overflow-hidden">
                <motion.div 
