...
const Leadership: React.FC = () => {
    return (
        <section id="leadership" className="relative py-32 bg-[#0d0d0d] overflow-hidden">
            ...
            <div className="max-w-7xl mx-auto px-6 relative z-10">
                ...
                <div className="text-center max-w-4xl mx-auto">
                    ...
                    >
                        ...
                        <h2 className="text-4xl md:text-6xl text-white font-bold tracking-tighter mb-12">
                            Who We Are
                        </h2>
                    </motion.div>
                    ...
                    <motion.p
                        ...
                        className="text-gray-400 text-lg md:text-xl leading-relaxed font-light mt-6"
                    >
