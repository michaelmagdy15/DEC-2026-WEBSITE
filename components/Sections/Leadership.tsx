            ...
            <div className="max-w-7xl mx-auto px-6 relative z-10">
                ...
                <div className="text-center max-w-4xl mx-auto">
                    ...
                    <motion.div
                        ...
                        dangerouslySetInnerHTML={{ __html: leadershipContent.paragraph1 || '<strong class="text-white">Dar Al Khaleej</strong> Engineering Consultants encourage a commitment to design excellence. We are a practice that values and respects our staff, fellow consultants, and our clients and the shared expertise we all provide.' }}
                    />
                    <motion.div
                        initial={{ opacity: 0 }}
                        whileInView={{ opacity: 1 }}
                        ...
                        dangerouslySetInnerHTML={{ __html: leadershipContent.paragraph2 || 'Our firm provides a working environment that fulfills aspiration, enhances knowledge and skills, and continuously builds a culture of excellence. Established in 1989, we have grown into one of the most respected engineering consultancy firms in the region, delivering iconic projects across the UAE and beyond.' }}
                    />
                </div>
