  ...
  return (
    ...
    >
      ...
      <div className="relative h-[85vh] w-full overflow-hidden">
        ...
        {/* Hero Text */}
        <motion.div 
            className="absolute bottom-0 left-0 w-full p-6 md:p-20 z-10"
        ...
        >
            <div className="max-w-4xl">
                ...
                <motion.h1 
                    ...
                    className="text-5xl md:text-8xl font-bold tracking-tighter text-white mb-6 leading-none"
                >
                    {project.title}
                </motion.h1>
                <motion.div 
